...
REPORT_SIGNING_SECRET = os.getenv("lexguard_aml_pdf_seal_9f3c7a1e_2026", "CHANGE_THIS_LEXGUARD_SECRET")
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    clear_flow(context)
        ...
        pdf_buffer, pdf_name = make_report_file(target, text, risk, score, lang)
        await update.message.reply_document(document=pdf_buffer, filename=pdf_name, caption=f"✅ <b>Your Custom Manual Audit Report</b>\n\n<i>Report ID: {pdf_name}</i>", parse_mode="HTML")
        clear_flow(context)
